...
namespace FlowerGarden
{
    class Startup
    {
        static void Main()
        {
            var height = new int[] { 5, 4, 3, 2, 1 };
            var bloom = new int[] { 1, 5, 10, 15, 20 };
            var wilt = new int[] { 5, 10, 14, 20, 25 };

            var result = getOrdering(height, bloom, wilt);
