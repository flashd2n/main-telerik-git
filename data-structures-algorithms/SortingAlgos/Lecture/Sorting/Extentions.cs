...
namespace SelectionSort
{
    ...
    {
        public static int[] CustomSelectionSort(this int[] array)
        {
        ...
        public static int[] CustomBubbleSort(this int[] array)
        {
            var arrLen = array.Length;
        ...
        public static int[] CustomInsertionSort(this int[] array)
        {
            var arrLen = array.Length;
            ...
            for (int i = 0; i < arrLen; i++)
            {
                ...
                if (entry > output[output.Count - 1])
                {
                    output.Add(entry);
                    continue;
                }

                var currentOutputCount = output.Count;

                for (int j = 0; j < currentOutputCount - 1; j++)
                {
                    if (entry > output[j] && entry < output[j + 1])
                    {
                        output.Insert(j + 1, entry);
                        break;
                    }
                }
        ...
        public static int[] InsertionSortArray(this int[] array)
        {
            var arrLen = array.Length;
            var output = new int[arrLen];
